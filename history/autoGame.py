...
def seekRolesManager():
    ...
    cv2.imwrite("sub000.png",subImage)
    if (subImage.sum())<140000:
...
def demoTest():
    ...
    fightTime = 2*sec
    print(fightTime)
    # img1=cv2.imread("buf.png",cv2.IMREAD_UNCHANGED)
    # cv2.imshow("img-colo",img1)
    # cv2.waitKey()
    # funOutputImgProperties(img1)
    #
    # img1=cv2.imread("buf.png",cv2.IMREAD_COLOR)
    # cv2.imshow("img-colo",img1)
    # cv2.waitKey()
    # funOutputImgProperties(img1)
    #
    # img1=cv2.imread("buf.png",cv2.IMREAD_GRAYSCALE)
    # cv2.imshow("img-colo",img1)
    # cv2.waitKey()
    # funOutputImgProperties(img1)
